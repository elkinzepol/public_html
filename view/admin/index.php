...
<head>
    ...
    <title>Elkinzepol | Administrador : <?php echo ucfirst($_SESSION['nombre']); ?> </title>
    ...
    <header id="top-header" class="navbar-inverse navbar-fixed-top">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="scroll">
                                <a class="nav-link" href="http://www.elkinzepol.online">Inicio</a>
                            </li>
                            <li class="scroll">
                                <a class="nav-link" href="http://www.elkinzepol.online/#about">¿Quiénes somos?</a>
                            </li>
                            <li class="scroll">
                                <a class="nav-link" href="http://www.elkinzepol.online/#features">Productos</a>
                            </li>
                            <li class="scroll">
                                <a class="nav-link" href="http://www.elkinzepol.online/#services">Servicios</a>
                            </li>
                            <li class="scroll">
                                <a class="nav-link" href="http://www.elkinzepol.online/#portfolio">Portafolio</a>
                            </li>
                            <li class="scroll">
                                <a class="nav-link" href="http://www.elkinzepol.online/#contact-area">Contáctenos</a>
                            </li>   
                    ...
                    <ul class="dropdown-menu animated flipInX">
                    	<li><a href="mensaje contactenos.php"><span class="fa fa-envelope" style="color:#11B80E"></span>&nbsp;Leer Mensajes de Contactenos</a>
                        </li>
