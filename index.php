<?php
  ...
  */
  ...
  if(isset($_SESSION['id'])){
	...
	// select usuario en sesion
	$res = $conn->query("SELECT * FROM usuarios WHERE id=" . $_SESSION['user']);
...
<body id="home" class="homepage" ondragstart="return false" onselectstart="return false">
  <!--Bloquear seleccionar y click derecho - onselectstart="return false" oncontextmenu="return false"-->
  ...
  <div id="cookieConsent">
      <div id="closeCookieConsent">x</div>
        ...
        <a href="politicas de privacidad.html" target="_blank">Mas informacion</a> 
        <a onclick="aceptar_cookies();" class="cookieConsentOK">Esta Bien</a>
  </div><!--/Mensaje de cookies-->
            ...
            <div class="container">
               ...
               <div id="navbar" class="collapse navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--Menu drop registro e inicio de sesion -->
                    <li class="dropdown">
                        <a href="http://phpoll.com/register" class="dropdown-toggle" data-toggle="dropdown">Registrarse<span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-lr animated flipInX" role="menu">
                            <div class="col-lg-12">
                                    
                                <!-- Estructura del formulario -->
                                	<div class="text-center"><h3><b>Registro</b></h3></div>
                                    <form id="formulario_registro" name="contact-form" method="post">
                                    	<fieldset>
                                    	 ...
                                    	 <label class="sr-only" for="user">Nombre</label>
                                   		 <div class="input-group">
                                     	 	...
                                     	 	<input id="name" type="text" class="form-control" name="name" placeholder="Ingresa tu nombre" required>
                                    	 </div>
                                 		 ...
                                 		 <div class="input-group">
                                   		 	...
                                   		 	<input id="email" type="email" class="form-control" name="email" placeholder="Ingresa tu email" required>
                                   		</div>
                    ...
                    <li class="dropdown">
                        <a href="http://phpoll.com/login" class="dropdown-toggle" data-toggle="dropdown">Ingresar <span class="caret"></span></a>
                        <ul class="dropdown-menu dropdown-lr animated slideInRight"" role="menu" >
                            <div class="col-lg-12">
                                ...
                                <!-- Caja de texto para usuario -->
            						...
            						<div class="row" id="load" hidden="hidden">
              							<div class="col-xs-4 col-xs-offset-4 col-md-2 col-md-offset-5">
                							<img src="img/load.gif" width="50%" alt="">
              							</div>
              							<div class="col-xs-12 center text-accent">
                							<span>Validando información...</span>
              							</div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 wow fadeInRight">
                    ...
                    <p>Para esto me he formado profesionalmente y comprometido con mis ideales.</p>
    ...
    <section id="cta2">
        <div class="container">
            <div class="text-center">
                <h2 class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">HAS TOMADO LA MEJOR DECISIÓN, <span>BIENVENIDO</span></h2>
                <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                	<b> <i> “Nuestra ilusión y la razón de existir es servir a nuestros clientes a cada instante de nuestras vidas”.</i> </b>
                 	<br>En nombre de Elkin López, les damos la más cordial bienvenida a nuestra página web.</br> 
                ...
                <div class="portfolio-item Business">
                    <div class="portfolio-item-inner">
                        ...
                        <div class="portfolio-info">
                            ...
                            <a class="preview" href="images/portfolio/.jpg" rel="prettyPhoto">
                                <img src="images/portfolio/expand.png" alt="">
